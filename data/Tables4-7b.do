...
* Table 4, Col 1
* reg log_num_languages = absolute latitude, NO FE

gen ln_number_lang = ln(num_languages)
reg ln_number_lang abs_lat
eststo col1

* Table 4, Col 2
* reg log_num_languages = absolute latitude, variation in elevation, variation in land quality, mean elevation, mean land quality, absolute latitude, NO country FE

reg ln_number_lang abs_lat sd_emean sd_suit avg emean abs_lat, robust
eststo col2

* Table 4, Col 2 (NEW)
* reg log_num_languages = absolute latitude, variation in elevation, variation in land quality, mean elevation, mean land quality, absolute latitude, YES country FE

reg ln_number_lang abs_lat sd_emean sd_suit avg emean abs_lat i.uniq_cnt25, robust
eststo col3

esttab col1 col2 col3, keep(abs_lat sd_emean sd_suit avg emean abs_lat)
